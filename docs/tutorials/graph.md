...
!!! tip "Notebook version"
    This tutorial is also available as a Jupyter notebook: [`notebooks/04_cache_graph.ipynb`](https://github.com/BIMSBbioinfo/cachepy/blob/main/notebooks/04_cache_graph.ipynb)
...
See the [notebook](https://github.com/BIMSBbioinfo/cachepy/blob/main/notebooks/04_cache_graph.ipynb) for the full diamond DAG example with visualisation.
